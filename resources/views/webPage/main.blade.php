                        ...
                        <div class="row">
                          <section style="padding: 20px;">
                              <div class="col-md-4 col-xs-12 pull-right">
                               <div class="pull-right">
                                   <img src="images/sponsors/1.png" class="img-responsive bounceIn animated" width="70" height="20"></a>  
                                
                                     <img src="images/sponsors/2.png" class="img-responsive bounceIn animated  " width="70" height="20"></a>  
                               </div>
                                     
                              
                                 
                            </div>
                            <div class="col-md-4 col-xs-12 pull-right  bounceInLeft animated"    >
                            <a href="index"  >
                            <img src="images/logo2.png" class="img-responsive" width="400" height="200" ></a>
                            </div>
                          </section>
